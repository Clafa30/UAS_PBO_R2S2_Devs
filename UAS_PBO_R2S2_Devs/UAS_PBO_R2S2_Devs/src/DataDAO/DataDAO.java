...
public class DataDAO {
    ...
    public DataDAO(HalamanUtama halamanUtama) {    
        ...
        // pastikan PanelRincian terinisialisasi dengan benar
    ...
    public void addToKeranjang(String menuId, int jumlah, double harga) {
        try (Connection conn = DbConnection.getConnection()) {
            ...
            pstmt.setString(3, pelangganId);     
            pstmt.setString(4, menuId);
            pstmt.executeUpdate();
      System.out.println("Item berhasil ditambahkan ke keranjang!");

            // refresh data setelah menambah item ke keranjang
            loadDataFromKeranjang();  // Memuat ulang data dari keranjang ke PanelRincian
    ...
    public void loadDataFromKeranjang() {
        try (Connection conn = DbConnection.getConnection()) {
            ...
            loadTotalFromKeranjang(halamanUtama.getPanelRincian1());  
    ...
    public void loadTotalFromKeranjang(PanelRincian panelRincian1) {
        ...
        try (Connection conn = DbConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                // Menampilkan hasil pada label di PanelRincian
