...
public class PanelRincian1 extends javax.swing.JPanel {
    ...
    public static synchronized PanelRincian1 getInstance(HalamanUtama halamanUtama) {
        if (instance == null) {
            instance = new PanelRincian1(halamanUtama);
        }
        return instance;
    }

    public PanelRincian1(HalamanUtama halamanUtama) {
